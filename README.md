...
```javascript
iterAhavercos = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-iter-special-ahavercos@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/math-iter-special-ahavercos/tags). For example,

```javascript
iterAhavercos = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-iter-special-ahavercos@v0.2.1-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var iterAhavercos = require( 'path/to/vendor/umd/math-iter-special-ahavercos/index.js' )
```
...
[test-image]: https://github.com/stdlib-js/math-iter-special-ahavercos/actions/workflows/test.yml/badge.svg?branch=v0.2.1
[test-url]: https://github.com/stdlib-js/math-iter-special-ahavercos/actions/workflows/test.yml?query=branch:v0.2.1
